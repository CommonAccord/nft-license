...
ArbitrationOrg.Name.Full=American Arbitration Association

ArbitrationOrg.Name.Short=AAA

Arbitration.Seat.City,State=Wilmington, Delaware
...
_ArbitrationOrg=<a href="#Def.ArbitrationOrg.Target">{ArbitrationOrg.Name.Short}</a>

Def.ArbitrationOrg.Target={_ArbitrationOrg}
